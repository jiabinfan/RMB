...
class ScriptArguments:
    ...
    optim: Optional[str] = field(default="adamw_torch",  metadata={"help": "The optimizer to use."}) # adamw_hf
...
training_args = TrainingArguments(
    output_dir=os.path.join(output_name, 'logs1'),
...
# Load datasets
train_dataset, eval_dataset = load_train_eval_dataset(script_args.dataset, tokenizer, size=100 if script_args.debug else None)
